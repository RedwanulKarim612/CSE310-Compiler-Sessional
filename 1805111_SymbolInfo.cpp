...
public:
    ...
    void setParameters(vector<SymbolInfo*>* params){
        for(int i=0;i<params->size();i++){
            // cout << params->at(i)->getRegister() << endl;
    ...
    void clone(SymbolInfo* symbol){
        ...
        this->positionOnStack = symbol->positionOnStack;
        this->savedOnReg = symbol->savedOnReg;
    }

    void setPositionOnStack(int x){
        this->positionOnStack = x;
        this->savedOnReg = to_string(this->positionOnStack) + "[BP]";
    }

    int getPositionOnStack(){
        return this->positionOnStack;
    }

    string getRegister(){
        return this->savedOnReg;
    }

    void setRegister(string x){
        this->savedOnReg = x;
    }
